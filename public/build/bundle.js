...
var app = (function () {
    ...
    const accordionContent = [
      ...
      {
        heading: "Can I use Frontend Mentor projects on my portfolio?",
        _content:
          "Yes, you can use projects completed on Frontend Mentor in your portfolio. It's an excellent way to showcase your skills to potential employers!",
      },
      {
        heading: "Can I get help if I'm stuck on a challenge?",
        _content:
    ...
    // (16:0) {#each accordionContent as { heading, _content }
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = text(t4_value);
    			t5 = space();
    			attr_dev(h4, "class", "svelte-1uz6tcy");
    			add_location(h4, file$3, 23, 8, 650);
    			attr_dev(span, "class", "btn svelte-1uz6tcy");
    			add_location(span, file$3, 24, 8, 678);
    			attr_dev(div0, "class", "div svelte-1uz6tcy");
    			add_location(div0, file$3, 22, 6, 623);
    			attr_dev(button, "class", "accordBtn svelte-1uz6tcy");
    			toggle_class(button, "active", /*isOpen*/ ctx[0][/*index*/ ctx[6]]);
    			add_location(button, file$3, 17, 4, 494);
    			attr_dev(div1, "class", "panel svelte-1uz6tcy");
    			toggle_class(div1, "open-panel", /*isOpen*/ ctx[0][/*index*/ ctx[6]]);
    			add_location(div1, file$3, 27, 4, 739);
    			attr_dev(div2, "class", "accord svelte-1uz6tcy");
    			add_location(div2, file$3, 16, 2, 468);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(16:0) {#each accordionContent as { heading, _content }",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	let each_1_anchor;
    	let each_value = accordionContent;
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*isOpen, accordionContent, toggleCollapse*/ 3) {
    				each_value = accordionContent;
    				validate_each_argument(each_value);
    				let i;
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	const toggleCollapse = index => {
    		...
    		$$invalidate(0, isOpen[index] = !isOpen[index], isOpen);
    	...
    	const click_handler = index => toggleCollapse(index);
    	$$self.$capture_state = () => ({ accordionContent, isOpen, toggleCollapse });
    	...
    	return [isOpen, toggleCollapse, click_handler];
    }
    ...
    const file$2 = "src/Accordion.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "star svelte-194djsd");
    			add_location(span, file$2, 6, 4, 99);
    			attr_dev(h1, "class", "svelte-194djsd");
    			add_location(h1, file$2, 7, 4, 131);
    			attr_dev(div, "class", "faq svelte-194djsd");
    			add_location(div, file$2, 5, 2, 76);
    			add_location(br, file$2, 9, 2, 158);
    			attr_dev(main, "class", "svelte-194djsd");
    ...
    function create_fragment$1(ctx) {
    	...
    	let accordion;
    	let current;
    	accordion = new Accordion({ $$inline: true });
